...
User.create!(
  ...
  first_name: "juri",
  last_name: "han",
  display_name: "jurihan",
  password: "password",
)
User.create(
  email: "littlefriend@gmail.com",
  first_name: "tony",
  last_name: "montana",
  display_name: "scarface",
  password: "password",
)
User.create(
  email: "quietlife@gmail.com",
  first_name: "yoshikage",
  last_name: "kira",
  display_name: "killerqueen",
  password: "password",
)
User.create(
  email: "baddad@gmail.com",
  first_name: "gendo",
  last_name: "ikari",
  display_name: "gendopose",
  password: "password",
)
User.create(
...
User.create(
  ...
  display_name: "ladygaga",
  password: "password",
)
User.create(
  email: "illustrious@gmail.com",
  first_name: "mari",
  last_name: "makinami",
  display_name: "zabeasto",
  password: "password",
)
User.create(
  email: "bondvillian@gmail.com",
  first_name: "elon",
  last_name: "musk",
  display_name: "chieftwit",
  password: "password",
)
User.create(
...
request.body =
  "fields name,cover.url,summary; where first_release_date < 946684799;"
